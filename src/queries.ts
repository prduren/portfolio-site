...
export enum FileFieldsEnum {
  ...
  ChildrenProjectsYamlPText = 'childrenProjectsYaml___pText',
  ChildrenProjectsYamlImage = 'childrenProjectsYaml___image',
  ChildrenProjectsYamlSc = 'childrenProjectsYaml___sc',
  ChildrenProjectsYamlLive = 'childrenProjectsYaml___live',
}
...
export type ProjectsYamlConnection = {
  ...
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: ProjectsYamlGroupConnection[];
};
...
export type ProjectsYamlFilterInput = {
  ...
  pText?: Maybe<StringQueryOperatorInput>;
  image?: Maybe<StringQueryOperatorInput>;
  sc?: Maybe<StringQueryOperatorInput>;
  live?: Maybe<StringQueryOperatorInput>;
};
